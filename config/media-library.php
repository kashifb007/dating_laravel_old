...
return [
    ...
    'custom_path_generators' => [
        \App\Models\Image::class => \App\Services\MediaLibrary\ImagePathGenerator::class,
        \App\Models\Language::class => \App\Services\MediaLibrary\FlagPathGenerator::class,
        \App\Models\Country::class => \App\Services\MediaLibrary\FlagPathGenerator::class,
        \App\Models\Post::class => \App\Services\MediaLibrary\PostPathGenerator::class,
        \App\Models\Category::class => \App\Services\MediaLibrary\CategoryPathGenerator::class,
    ],
