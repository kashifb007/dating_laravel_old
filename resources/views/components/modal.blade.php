...
<div
    ...
    x-show="show"
    class="flex items-center fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50"
...
>
    ...
    >
        <div class="absolute inset-0 bg-gray-600 dark:bg-gray-900 opacity-80"></div>
    </div>
    ...
    >
        @if ($showHeader)
            <div class="flex items-center justify-between bg-[#ededed] px-5 py-3 dark:bg-[#273346]">
                <div class="text-lg font-bold">{{ $title }}</div>
                <button type="button" class="text-white-dark hover:text-dark hover:cursor-pointer" x-on:click="$dispatch('close-modal', '{{ $name }}')" title="Close modal">
